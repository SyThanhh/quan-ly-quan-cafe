...
if ($stmt = mysqli_prepare($conn, $sql)) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo '<div style="text-align: center; color: red;">Không tìm thấy hồ sơ giao dịch.</div>';
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <div class="w-100">
                    ...
                    <?php if (isset($_SESSION['loggedinCustomer']) && $_SESSION['loggedinCustomer'] === true): ?>
                        ...
                        <?php else: ?>
                            <a class="btn btn-secondary font-weight-bold px-3" href="index.php?page=register" style="margin-left: 132px; background-color: #DA9F5B;">Đăng ký ngay</a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
